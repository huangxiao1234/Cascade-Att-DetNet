...
class _FPN(nn.Module):
    ...
    def forward(self, im_data, im_info, gt_boxes, num_boxes):
        ...
        c2 = c2.mul(self.RCNN_attention1(c1))+c2
        c3 = self.RCNN_layer2(c2)
        # print("c3",c3.size())
        c3 = c3.mul(self.RCNN_attention2(c2))+c3
        c4 = self.RCNN_layer3(c3)
        # print("c4",c4.size())
        # print("a3",self.RCNN_attention3(c3).size())
        c4 = c4.mul(self.RCNN_attention3(c3))+c4
        c5 = self.RCNN_layer4(c4)
        # print("c5",c5.size())
        c5 = c5.mul(self.RCNN_attention4(c4))+c5
        c6 = self.RCNN_layer5(c5)
        # print("c6",c6.size())
        c6 = c6.mul(self.RCNN_attention5(c5))+c6
