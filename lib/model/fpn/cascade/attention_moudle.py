...
class AttentionModule_stage0(nn.Module):
    ...
    def __init__(self, in_channels, out_channels1, size1=(150, 200), size2=(75, 100), size3=(38, 50), size4=(19, 25)):
        ...
        self.softmax8_blocks = nn.Sequential(
            ...
            nn.BatchNorm2d(out_channels),
            nn.ReLU(inplace=True),
            nn.Conv2d(out_channels, out_channels1 , kernel_size=1, stride=1, bias = False),
            nn.Sigmoid()
        )
    ...
    def forward(self, x):
        ...
        out_interp1 = self.interpolation1(out_softmax7)
...
class AttentionModule_stage1(nn.Module):
    # input size is 56*56
    def __init__(self, in_channels, out_channels1,size1=(75, 100), size2=(75, 100), size3=(38, 50)):
    ...
    def forward(self, x):
        # print("x",x.size())
        out_mpool1 = self.mpool1(x)
        # print(out_mpool1.size())
        out_softmax1 = self.softmax1_blocks(out_mpool1)
        out_skip1_connection = self.skip1_connection_residual_block(out_softmax1)
        out_mpool2 = self.mpool2(out_softmax1)
        # print(out_mpool2.size())
        out_softmax2 = self.softmax2_blocks(out_mpool2)
        out_skip2_connection = self.skip2_connection_residual_block(out_softmax2)
        out_mpool3 = self.mpool3(out_softmax2)
        # print(out_mpool3.size())
        out_softmax3 = self.softmax3_blocks(out_mpool3)
        #
        # print("out_softmax3",out_softmax3.size(),"out_softmax2",out_softmax2.size())
...
class AttentionModule_stage2(nn.Module):
    ...
    def __init__(self, in_channels, out_channels1, size1=(75, 100), size2=(38, 50)):
